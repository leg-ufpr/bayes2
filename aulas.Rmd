...
- **11/03 (Qua)**: Aproximações da posteriori.
  - Pré aula: [arquivo1](scripts/03a-propDiscreta.R), [arquivo2](scripts/03b-posteriorAprox.R), [arquivo3](scripts/03c-propMCMCPacks.R)
