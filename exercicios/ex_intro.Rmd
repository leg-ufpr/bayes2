---
title: "CE315 - Inferência bayesiana"
...
fazer um teste de varredura (*screening*), isto é, o teste é 
para verificar se o indivíduo possui anticorpos para a doença é 
...
3) No contexto da questão (1), deseja-se agora inferir sobre a proporção
...
4) Os dados a seguir referem-se a tamanhos de mandíbuldas de fêmeas e
...
5) No contexto do problema (4), voce deve ter resolvido de alguma forma,
