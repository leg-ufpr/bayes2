...
subtitle: .small[E o que isso tem a ver com inferência bayesiana...]
author: "Fernando de Pol Mayer (LEG/DEST/UFPR)"
date: 2022-02-03 .footnotesize[(última atualização `r Sys.Date()`)]
output:
...
## Para gerar o PDF
xaringanBuilder::build_pdf("metodo-cientifico-inferencia-bayesiana.Rmd")
```
